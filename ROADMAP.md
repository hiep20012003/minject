...
builder.register((b) =>
  b.bind(EventHandler).to(LoggingHandler).asSingleton()
);
builder.register((b) =>
  b.bind(EventHandler).to(MetricsHandler).asSingleton()
);
...
*This plan is a living document. Update as priorities shift and work is completed.*
